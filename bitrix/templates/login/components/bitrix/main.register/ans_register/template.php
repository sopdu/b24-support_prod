        ...
        <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
            ...
            <table style="width: 100%">
                ...
                <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
                    <?/*<tr><td colspan="2">222<?=strlen(trim($arParams["USER_PROPERTY_NAME"])) > 0 ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB")?></td></tr>*/?>
                    <?foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField):?>
                        <?#='<pre>'; print_r($arUserField["EDIT_FORM_LABEL"]); '</pre>';?>
                        <?
                            if($arUserField["EDIT_FORM_LABEL"] == 'Группа экстранета'){
                                $arUserField["EDIT_FORM_LABEL"] = 'Компания';
                            }
                        ?>
                ...
                <tfoot>
                <tr>
                    <td colspan="2" style="text-align: center"><input class="login-btn" type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" /></td>
                </tr>
                </tfoot>
            </table>
